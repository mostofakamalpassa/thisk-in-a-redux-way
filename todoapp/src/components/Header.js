...
import {added} from '../redux/todos/actionCreator';
  ...
  return (
    <div>
      <form onSubmit={handleFormSubmit} className="flex items-center bg-gray-100 px-4 py-4 rounded-md">
        <img src="/assets/images/notes.jpg" className="w-6 h-6" alt="Add todo" />
        <input
          type="text"
      ...
      <ul className="flex justify-between my-4 text-xs text-gray-500">
        <li className="flex space-x-1 cursor-pointer">
          <img className="w-4 h-4" src="./assets/images/double-tick.png" alt="Complete" />
